...
const Index = () => {
  ...
  return <div className="min-h-screen bg-gray-50">
      <header className="bg-white shadow-sm py-6 border-b">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <h1 className="text-3xl font-bold text-gray-900">Vibe Fund</h1>
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <PredictionChart stockSymbol={selectedStock} predictions={predictions} />
        </div>
        
        <div>
          <PredictionDetails stockSymbol={selectedStock} predictions={predictions} />
        </div>
      </main>
